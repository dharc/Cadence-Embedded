...
#ifndef _CADENCE_CORE_DEFINITION_H_
#define _CADENCE_CORE_DEFINITION_H_
	...
	namespace core {
		...
		*/
		class DVMIMPORT Definition {
			...
			Definition() { m_def = cadence::core::OID::create(); m_size = 0; };
			/**
			* Constructor to use an existing definition.
			* @param o The object representing the definition.
			*/
			Definition(const cadence::core::OID &o) : m_def(o) { m_size = (OID)m_def[Size]; };
			
			/**
			 * Constructor for compiled definitions.
			 */
			Definition(const cadence::core::OID &o, void *c) : m_def(o), m_comp(c) { };
			...
			* @return This.
			*/
			Definition operator()(const cadence::core::OID &o);
	
			/**
			* Cast to OID to get definition object. This does not evaluate the
			* definition.
			*/
			operator cadence::core::OID() const { return m_def; };
			...
			*/
			cadence::core::OID evaluate(const cadence::core::OID &obj, const cadence::core::OID &key, bool fdef=false);
			...
			cadence::core::OID parseExpression(cadence::core::Context *ctx, cadence::core::Buffer *def, int &index, bool fdef);
		};
	};
};
