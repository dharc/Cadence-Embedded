...
#ifndef _CADENCE_CORE_EVENT_H_
#define _CADENCE_CORE_EVENT_H_
...
template <unsigned int I>
inline const cadence::core::OID &cadence::core::Event::param() {
	if (I > MAX_PARAMETERS)	return cadence::core::Null;
	return m_p[I];
}
	
template <unsigned int I>
inline void cadence::core::Event::param(const cadence::core::OID &p) {
