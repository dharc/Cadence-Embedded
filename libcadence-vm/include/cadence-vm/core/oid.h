...
#ifndef _CADENCE_CORE_OID_H_
#define _CADENCE_CORE_OID_H_
...
namespace cadence {
	...
	namespace core {
		...
		class DVMIMPORT OID {
			 ...
			 */
			template <typename T>
			operator T*() const { return get_pointer<T>(cadence::core::is_pod<T>()); };
...
template <typename T>
cadence::core::OIDAccessor cadence::core::OID::operator[](const T &o) const { return cadence::core::OIDAccessor(*this, o); };

bool cadence::core::operator==(const cadence::core::OID &o1, const cadence::core::OID &o2) {
	//#ifdef X86_64
...
namespace cadence {
namespace core{
bool operator<(const cadence::core::OID &o1, const cadence::core::OID &o2) {
	//#ifdef X86_64
	//return (o1.m_128 < o2.m_128);
	//#else
...
cadence::core::OID operator&(const cadence::core::OID &o1, const cadence::core::OID &o2) {
	return cadence::core::OID(o1.m_a & o2.m_a, o1.m_b & o2.m_b, o1.m_c & o2.m_c, o1.m_d & o2.m_d);
}
...
bool operator==(const cadence::core::OID::iterator &i1, const cadence::core::OID::iterator &i2) {
