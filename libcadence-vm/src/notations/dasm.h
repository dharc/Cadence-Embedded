...
namespace cadence {
	class DASM : public Notation {
		...
		bool parseDefinition(OID &context, OID &cur, int &i, bool real, bool ncontext=false, bool endnl=false);
		bool parseString(OID &cur);
		bool parseIf(OID &context, int &i, OID &cur, bool imed=false);
		bool parseSelect(OID &context, int &i, OID &cur, bool imed=false);
