...
OID cadence::core::OID::s_local = OID(1,0,0,0);
...
bool cadence::core::operator==(const OIDAccessor &acc, const OID &o) {
	return (OID)acc == o;
}

OID cadence::core::OID::get(const OID &o) const {
...
Definition cadence::core::OID::operator()(const OID &o) const {
